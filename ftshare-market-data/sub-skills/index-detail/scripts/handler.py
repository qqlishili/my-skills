...
ENDPOINT = "/api/v1/market/data/daec/index"
...
def fetch(index: str, masks: Optional[str] = None) -> dict:
    params = build_params(index, masks)
...
def main():
    parser = argparse.ArgumentParser(description="查询单只指数详情（daec）")
    parser.add_argument(
        "--index",
        required=True,
    ...
    result = fetch(args.index, args.masks)
