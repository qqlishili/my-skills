...
def main():
    parser = argparse.ArgumentParser(description="基金行情日线")
    parser.add_argument("--fund_code", required=True, help="基金代码")
    parser.add_argument("--trade_date", required=False, help="交易日期 YYYYMMDD（与 start/end 互斥）")
    parser.add_argument("--start_date", required=False, help="起始日期 YYYYMMDD（需与 end_date 同传）")
    parser.add_argument("--end_date", required=False, help="结束日期 YYYYMMDD")
