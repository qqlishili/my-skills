#!/usr/bin/env python3
"""Tests for fund-daily-paginated handler"""
import json
import sys
import unittest
...
class TestFetch(unittest.TestCase):
    ...
    def test_fetch_forwards_to_endpoint(self, mock_open):
        ...
        self.assertIn("/api/v1/market/data/fund/fund-daily", url)
...
class TestMain(unittest.TestCase):
    ...
    def test_main_emits_json(self, mock_open):
        mock_open.return_value.__enter__.return_value.read.return_value = b'[]'
        argv = ['handler.py']
        argv += ['--fund_code', '510300']
        argv += ['--trade_date', '20260717']
        argv += ['--page', '1']
        argv += ['--page_size', '50']
