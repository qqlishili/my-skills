#!/usr/bin/env python3
"""Tests for index-list-paginated handler"""
import json
import sys
import unittest
import urllib.error
...
class TestBuildParams(unittest.TestCase):
    ...
    def test_page_no_mapped_to_page(self):
        p = handler.build_params(page_no=3, page_size=10)
...
class TestFetch(unittest.TestCase):
    ...
    def test_url_uses_daec_indices_with_page(self, mock_open):
        ...
        self.assertIn("daec/indices", url)
    ...
    def test_items_ts_millis_converted(self, mock_open):
        mock_open.return_value.__enter__.return_value.read.return_value = (
            b'{"items":[{"symbol":"000001.XSHG","close":"4057.74","ts_millis":1780300786000}],"page":1,"total_pages":1,"total_items":1}'
        )
