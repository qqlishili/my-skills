...
def main():
    parser = argparse.ArgumentParser(description="基金持有人结构")
    parser.add_argument("--fund_code", required=True, help="基金代码（如 000001 或 000001.OF）")
    parser.add_argument("--report_type", required=False, help="报告类型：年度报告/中期报告/上市公告书/基金合同生效公告，缺省全部")
    parser.add_argument("--start_date", type=int, required=False, help="报告期起始日期 YYYYMMDD")
    parser.add_argument("--end_date", type=int, required=False, help="报告期截止日期 YYYYMMDD")
