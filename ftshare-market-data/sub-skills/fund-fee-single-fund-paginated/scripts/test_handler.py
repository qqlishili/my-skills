#!/usr/bin/env python3
"""Tests for fund-fee-single-fund-paginated handler"""
import json
import sys
import unittest
...
class TestFetch(unittest.TestCase):
    ...
    def test_fetch_forwards_to_endpoint(self, mock_open):
        ...
        args.charge_type = None
        args.client_type = None
        args.page = None
        args.page_size = None
        handler.fetch(args)
        url = mock_open.call_args[0][0]
        self.assertIn("/api/v1/market/data/fund/fund-fee", url)
