#!/usr/bin/env python3
"""批量查询多只标的 K 线（POST /api/v1/market/data/stock-candlesticks/batch）"""
import argparse
import json
import sys
import urllib.error
...
def main():
    parser = argparse.ArgumentParser(description="批量查询多只标的 K 线（POST + JSON body）")
    parser.add_argument("--symbols", required=True,
                        help="标的代码列表，逗号分隔，如 600519.SH,510300.SH,113027.SH,000300.SH")
