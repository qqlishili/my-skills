#!/usr/bin/env python3
"""批量查询多只指数 K 线（POST /api/v1/market/data/index-candlesticks/batch）"""
import argparse
import json
import sys
import urllib.error
...
def main():
    parser = argparse.ArgumentParser(description="批量查询多只指数 K 线（POST + JSON body）")
    parser.add_argument("--symbols", required=True,
                        help="指数代码列表，逗号分隔，如 000300.XSHG,399001.XSHE")
