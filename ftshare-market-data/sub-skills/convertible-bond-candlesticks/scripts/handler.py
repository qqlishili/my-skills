#!/usr/bin/env python3
"""查询单只可转债历史 K 线（POST /api/v1/market/data/convertible-bond-candlesticks）"""
import argparse
import json
import sys
import urllib.error
...
def main():
    parser = argparse.ArgumentParser(description="查询单只可转债历史 K 线（POST + JSON body）")
    parser.add_argument("--symbol", required=True, help="可转债代码，如 113027.SH、123001.SZ")
