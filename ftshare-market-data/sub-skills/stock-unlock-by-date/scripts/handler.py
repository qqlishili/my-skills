#!/usr/bin/env python3
"""按解禁日期范围查询限售解禁批次及股东明细（market.ft.tech）"""
import argparse
import json
import sys
import urllib.error
...
def main():
    parser = argparse.ArgumentParser(description="按解禁日期范围查询限售解禁")
    ...
    path = "/api/v1/market/data/unlock/stock-unlock-by-date?" + urllib.parse.urlencode(params)
    url = BASE_URL + path
